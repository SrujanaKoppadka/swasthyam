						...
						return (
							...
							>
								...
								<div className="p-8 relative z-10 flex-1 flex flex-col">
									<div className="w-14 h-14 rounded bg-blue-50 flex items-center justify-center mb-6 shadow-inner border border-blue-100 group-hover:bg-brand-gold/10 transition-colors">
										<Icon
											className={`w-7 h-7 ${specialty.iconColor} group-hover:scale-110 transition-transform`}
											strokeWidth={1.5}
										/>
									</div>
