			...
			<div className="max-w-7xl mx-auto px-6 mt-16 text-slate-600">
				<div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
					<div className="order-2 lg:order-1">
						...
						<h2 className="text-3xl md:text-4xl font-bold text-[#1a2340] mb-6">
							A Legacy of{" "}
							<span className="text-brand-gold">Trusted Healing</span>
						</h2>
						<p className="text-lg leading-relaxed mb-6 font-light text-slate-700">
						...
						<p className="leading-relaxed mb-8 text-slate-500 text-sm">
						...
						<div className="flex gap-4">
							<div className="glass-card card-lift p-4 flex-1">
								<div className="stat-line">
									...
									<p className="text-[10px] text-brand-gold uppercase tracking-wider">
										Emergency Care
									</p>
								</div>
							</div>
				...
				<div className="grid md:grid-cols-2 gap-8 mt-24">
					<div className="glass-card card-lift p-10 relative overflow-hidden group">
						...
						<Sparkles
							className="w-12 h-12 text-brand-gold mb-6"
							strokeWidth={1.5}
						/>
						<h3 className="text-2xl font-bold text-[#1a2340] mb-4 uppercase tracking-widest text-sm border-b border-brand-gold/30 pb-2 inline-block">
							Our Vision
						</h3>
					...
					<div className="glass-card card-lift p-10 relative overflow-hidden group">
						...
						<HeartPulse
							className="w-12 h-12 text-brand-orange mb-6"
							strokeWidth={1.5}
						/>
						<h3 className="text-2xl font-bold text-[#1a2340] mb-4 uppercase tracking-widest text-sm border-b border-brand-orange/30 pb-2 inline-block">
							Our Mission
						</h3>
						<p className="text-slate-600 leading-relaxed pt-2">
				...
				<div className="mt-24 pt-20 border-t border-blue-50">
					<div className="max-w-4xl mx-auto relative overflow-hidden glass-card card-lift p-10 md:p-14 rounded-3xl">
						{/* Background Glow */}
						<div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-64 bg-brand-orange/10 blur-3xl rounded-full"></div>
						...
						<div className="relative z-10 text-center mb-10">
							...
							<h3 className="text-3xl md:text-4xl font-bold text-[#1a2340] leading-tight">
						...
						<div className="relative z-10">
							<blockquote className="text-lg md:text-2xl text-slate-700 italic font-light leading-relaxed text-center max-w-3xl mx-auto relative">
								<span className="absolute -top-10 left-0 text-7xl text-brand-gold/20 font-serif">
									“
								</span>
								...
								empathy."
								<span className="absolute -bottom-16 right-0 text-7xl text-brand-gold/20 font-serif">
									”
								</span>
							</blockquote>
						</div>
				...
				<div className="mt-24 bg-gradient-to-tr from-brand-blue/20 to-transparent border border-brand-blue/30 rounded p-12 text-center relative overflow-hidden">
					...
					<div className="relative z-10">
						<h2 className="text-3xl font-bold text-[#1a2340] mb-4">
